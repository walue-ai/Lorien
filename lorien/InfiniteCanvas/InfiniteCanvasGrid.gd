...
var _grid_size := preload("res://Config.gd").DEFAULT_GRID_SIZE
var _grid_color: Color

# -------------------------------------------------------------------------------------------------
func _ready() -> void:
	_grid_size = Settings.get_value(Settings.APPEARANCE_GRID_SIZE, preload("res://Config.gd").DEFAULT_GRID_SIZE)
	_pattern = Settings.get_value(Settings.APPEARANCE_GRID_PATTERN, preload("res://Config.gd").DEFAULT_GRID_PATTERN)
